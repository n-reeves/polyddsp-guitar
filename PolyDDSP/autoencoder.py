...
from PolyDDSP.decoder import Decoder
from PolyDDSP.encoder import Encoder
...
class AutoEncoder(nn.Module):
    ...
    def forward(self, x):
        ...
        return audio, noise, reverbed, parts, output
